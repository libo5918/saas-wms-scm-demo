...
public class StockLockRequest {
    ...
    private List<StockLockItemRequest> items = new ArrayList<>();
    ...
    public List<StockLockItemRequest> getItems() { return items; }
    public void setItems(List<StockLockItemRequest> items) { this.items = items; }
}

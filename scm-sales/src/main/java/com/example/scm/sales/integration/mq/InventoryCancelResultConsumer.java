...
public class InventoryCancelResultConsumer {
    ...
    private static final String CONSUMER_GROUP = "scm-sales-cancel-result-consumer";
    private static final String TOPIC = "inventory.cancel.result.v1";
    private static final long SYSTEM_OPERATOR_ID = 1L;

    private final MqConsumeLogMapper mqConsumeLogMapper;
    private final SalesOrderMapper salesOrderMapper;

    public InventoryCancelResultConsumer(MqConsumeLogMapper mqConsumeLogMapper, SalesOrderMapper salesOrderMapper) {

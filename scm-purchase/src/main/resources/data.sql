INSERT INTO purchase_receipt (
    id, tenant_id, receipt_no, purchase_order_id, warehouse_id, receipt_status, created_by, updated_by, deleted
) VALUES
    (1, 1, 'RCV-001', 5001, 2001, 'STOCK_IN_SUCCESS', 1, 1, 0),
    (2, 1, 'RCV-002', 5002, 2001, 'STOCK_IN_SUCCESS', 1, 1, 0)
